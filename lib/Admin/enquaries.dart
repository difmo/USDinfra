...
class _AdminEnquiriesPageState extends State<AdminEnquiriesPage> {
  ...
  void _deleteEnquiry(String enquiryId) async {
    try {
      await FirebaseFirestore.instance.collection("AppContacts").doc(enquiryId).delete();
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Inquiry deleted successfully!"), backgroundColor: Colors.red),
      );
    } catch (error) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Failed to delete inquiry: $error"), backgroundColor: Colors.red),
      );
    }
  }
    ...
    return Scaffold(
      ...
      //     : enquiriesList.isEmpty
        ...
        itemBuilder: (context, index) {
          ...
          Timestamp? createdAtTimestamp = enquiry["createdAt"] as Timestamp?;
          DateTime createdAt = createdAtTimestamp != null ? createdAtTimestamp.toDate() : DateTime.now();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Phone: $mobile", style: TextStyle(fontSize: 14)),
                    SizedBox(height: 10),
                    ...
                    Align(
                      ...
                      child: Text("Date: $formattedDate", style: TextStyle(fontSize: 12, color: Colors.grey)),
                    ),
                  ],
                ),
              ),
