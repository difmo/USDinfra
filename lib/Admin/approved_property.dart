...
//     return Scaffold(
//       appBar: CustomAppBar(title: "Approved Properties"),
//       body: StreamBuilder<QuerySnapshot>(
//         stream: FirebaseFirestore.instance
//             .collection("AppProperties")
//             .where("isDeleted", isEqualTo: false)
//             .where("isApproved", isEqualTo: true) // ✅ Show only approved properties
//             .snapshots(),
...
//                   : "N/A";
//               String imageUrl = property["imageUrl"] ?? "https://via.placeholder.com/150";
//
//               return Card(
