...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           Text(propertyData?['title'] ?? "No Title",
//               style:
...
//               Expanded(
//                 child: Text(propertyData?['locality'] ?? "No Address Provided",
//                     style: TextStyle(fontSize: 16, color: Colors.grey[700])),
//               ),
//             ],
//           ),
//           // _infoRow("Built Year", propertyData?['plotArea'] ?? "N/A"),
//           _infoRow("Plot Area", propertyData?['plotArea'] ?? "N/A"),

//           _infoRow(
//               "Floor Number",
//               // ${propertyData?['floorNumber'] ?? 'N/A'} /
//               " ${propertyData?['totalFloors'] ?? 'N/A'}"),
//           _infoRow("Furnishing Status",
...
//         children: [
//           Text("Total: Rs/- ${propertyData?['expectedPrice'] ?? 'N/A'}",
//               style: TextStyle(
//                   fontSize: 20,
//                   fontWeight: FontWeight.bold,
