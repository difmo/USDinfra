...
class _FavoritePropertiesPageState extends State<FavoritePropertiesPage> {
  ...
  Future<void> _fetchFavoritePropertyIds() async {
    ...
    if (userDoc.exists) {
      ...
      setState(() {
        favoritePropertyIds = List<String>.from(data?['favoriteProperties'] ?? []);
      });
    }
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance
            ...
            .where(FieldPath.documentId, whereIn: favoritePropertyIds.isEmpty ? ['dummy'] : favoritePropertyIds)
            .get(),
    ...
    return InkWell(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PropertyDetailPage(docId: 'propertyData',),
          ),
        );
      },
      child: Card(
