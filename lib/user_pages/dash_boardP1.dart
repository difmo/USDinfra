...
class _HomeDashBoard extends State<HomeDashBoard> {
  ...
  @override
  void initState() {
    print('HomeDashBoard: initState called');
    fetchdata();
    super.initState();
  }

  void fetchdata() async {
    print("HomeDashBoard: fetchdata called");
    UserModel? userdata = await _userController.fetchCurrentUserData();
    print("HomeDashBoard: fetchCurrentUserData returned: $userdata");
  }
                                            ...
                                            child: Center(
                                              child: GestureDetector(
                                                ...
                                                child: Icon(
                                                  Icons.favorite,
                                                  size:
                                                      16, // Optional: smaller size to fit nicely
                                                  color: isFavorite
                                                      ? Colors.red
                                                      : Colors.grey,
                                                ),
